      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800 rounded-lg shadow-xl border border-gray-700 p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-white">Join LeetCode</h1>
            <p className="text-gray-400 mt-2">Create your account to start coding</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                autocomplete="off"
                className={`w-full px-3 py-2 bg-gray-700 border ${errors.firstName ? 'border-red-500' : 'border-gray-600'
